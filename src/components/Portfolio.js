...
export default function Portfolio() {
    return (
        <div >
            ...
            <button href="https://www.behance.net/ohmegakilo" class="absolute right-0 h-[55px] w-[150px] text-[15px] sm:h-[60px] sm:w-[180px] sm:text-[20px] mr-[30px] mt-[30px] rounded-[50px] text-center text-gray-500 font-[500] sm:font-[300] border-[1px] border-gray-600 hover:border-gray-500 hover:bg-[rgb(10,10,10)]">
                <span class=''>View Portfolio</span>
            </button>
